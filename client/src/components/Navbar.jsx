...
const Navbar = ({ userData }) => {
  ...
  const navLinks = {
    ...
    recruiter: [
      ...
      {
        label: "Post Job",
        href: "/recruiter/recruiter-postjob",
        shortcut: "Ctrl + PJ",
      },
      {
        label: "Candidates",
        href: "/recruiter/recruiter-candidates",
        shortcut: "Ctrl + C",
      },
      {
        label: "History",
        href: "/recruiter/recruiter-history",
        shortcut: "Ctrl + C",
      },
    ],
  };
        ...
        <div className="hidden md:flex md:flex-row items-center gap-3 w-full md:w-auto mt-4 md:mt-0">
          ...
          {isLoggedIn ? (
            ...
            <button
              ...
              className="relative z-10 w-full md:w-[6.5em] h-[2.3em] m-2 px-4 py-2 bg-black text-white border-none rounded-[0.625em] text-[16px] md:text-[20px] font-bold cursor-pointer overflow-hidden group transition-all duration-300 ease-in-out hover:bg-gray-900 hover:text-black"
            >
              Login
